...
public class Welcome : EditorWindow 
{
	...
	/******* TO MODIFY **********/
	/******* TO MODIFY **********/
	private const string ONLINE_DOC_URL = "https://dl.dropboxusercontent.com/u/8289407/ninjaheroassetstore/documentation/html/annotated.html";
	private const string RATEUS_URL = "http://u3d.as/mYg";

	private const string NAME_OF_THE_GAME = "NINJA HERO";
	/******* TO MODIFY **********/
	/******* TO MODIFY **********/
	/******* TO MODIFY **********/
	/******* TO MODIFY **********/
